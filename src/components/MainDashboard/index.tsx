...
import { StyledMainDashboard, StyledMainDashboardHeader } from "../../pages/MainDashboard/style";
...
export const MainDashboardComponent = () => {
  ...
  const [isModalOpenRegister, setIsModalOpenRegister] = useState<boolean>(false);
      ...
      <StyledMainDashboard>
        <div>
          <section>
            ...
            <h2>Juntos</h2>
            <p>
              Junte-se à luta contra o desperdício alimentício e ajude a salvar alimentos
              perfeitamente bons que de outra forma iriam para o lixo.
            </p>
            <small>
              Descubra lojas e restaurantes perto de você com a EatSmart e evite que sacolas
              surpresa de mantimentos excedentes sejam desperdiçadas - adquirindo por um ótimo
              preço.
            </small>
          </section>
          <section>
