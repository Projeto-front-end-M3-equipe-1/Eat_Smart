...
import { StyledParagraph, StyledTitleGreen, StyledTitleWhite } from "./../../styles/typography";
    ...
    <StyledContainer>
      ...
      <section>
        <StyledFormUserDark>
          ...
          <StyledParagraph className="category" textAlign="center" fontColor="white">
            Error
          </StyledParagraph>
          <StyledButton $buttonSize="default" $buttonStyle="buttonGreenLight">
            Button Color 2
      ...
      <section>
        <StyledFormUserLight>
          ...
          <StyledParagraph className="category" textAlign="center" fontColor="black">
            Error
          </StyledParagraph>
          <StyledButton $buttonSize="default" $buttonStyle="buttonGreenDark">
            Button Color 2
